...
El poder del vendedor se reduce a un tercio. Una explicación posible: las salidas sin cargo se deciden **antes**, y con el jugador, no con el club comprador.
:::
...
Lo que el club maximiza es **utilidad**, no ingresos: éxito deportivo, asistencia y salud de la liga, con el beneficio económico como restricción (Sloane, 1971).
:::
...
El atributo personal más determinante. La relación estimada es lineal decreciente, sin el tramo creciente que supone la forma cuadrática.
:::

::: {style="background: rgba(255,255,255,0.055); border-radius: 10px; padding: 14px 16px; border-left: 4px solid #9b59b6;"}
[Posición]{style="color: #9b59b6; font-weight: bold;"}

Resulta significativa en mediocampistas y delanteros, tomando a los defensores como categoría base.
:::

::: {style="background: rgba(255,255,255,0.055); border-radius: 10px; padding: 14px 16px; border-left: 4px solid #9b59b6;"}
[Porteros]{style="color: #9b59b6; font-weight: bold;"}

La escasez de observaciones y lo diferente de su rol vuelven inestable el coeficiente. Amerita evaluar su exclusión.
:::

::: {style="background: rgba(255,255,255,0.055); border-radius: 10px; padding: 14px 16px; border-left: 4px solid #9b59b6;"}
[Nacionalidad]{style="color: #9b59b6; font-weight: bold;"}

El pasaporte comunitario pierde peso al incorporar los identificadores de los clubes. Opera como señal de acceso al fútbol europeo.
:::
...
Solo las estadísticas de mayor reconocimiento, partidos jugados y goles, muestran influencia. El resto no reúne evidencia suficiente.
:::
...
Las ventanas de transferencia restantes conservan su efecto en las tres estimaciones. La proximidad del vencimiento reduce el precio.
:::
...
Franceschi (2024) revisa sistemáticamente **29 artículos** con **111 especificaciones** sobre valoración de futbolistas. Predominan las ligas europeas —la Premier League es la más estudiada— con solo dos casos fuera de Europa. En las **82** especificaciones que incorporan la edad, la forma funcional se distribuye así:
:::

:::: {style="font-size: 0.66em; line-height: 1.5;"}

::: {style="background: linear-gradient(to right, rgba(189,195,199,0.30) 54%, transparent 54%); padding: 9px 16px; margin-bottom: 8px;"}
Forma de U invertida · **44** especificaciones (54%)
:::

::: {style="background: linear-gradient(to right, rgba(189,195,199,0.30) 28%, transparent 28%); padding: 9px 16px; margin-bottom: 8px;"}
Sin relación significativa · **23** (28%)
:::

::: {.fragment style="background: linear-gradient(to right, rgba(155,89,182,0.55) 13%, transparent 13%); padding: 9px 16px; margin-bottom: 8px; border-left: 3px solid #9b59b6;"}
Relación decreciente · **11** (13%) — [la forma hallada en este trabajo]{style="color: #9b59b6;"}
:::

::: {style="background: linear-gradient(to right, rgba(189,195,199,0.30) 4%, transparent 4%); padding: 9px 16px;"}
Forma de U · **3** (4%)
:::

::::

::: {.fragment style="font-size: 0.68em; line-height: 1.5; margin-top: 6px;"}
...
:::::: {style="flex: 1; display: grid; grid-template-columns: 72% 28%; gap: 30px; align-items: center; align-content: center; margin-left: 22px;"}

::::: {.fragment style="font-size: 0.8em; line-height: 1.45;"}

:::: {style="border-left: 3px solid #2ecc71; padding-left: 18px; margin-bottom: 16px;"}
**Vendedores · poder positivo** · Obtienen mejores precios cuanto mayor es el valor de su plantel, en tanto poseen el rendimiento que la competencia deportiva demanda.
::::

:::: {style="border-left: 3px solid #e74c3c; padding-left: 18px;"}
**Compradores · poder negativo** · Pagan más cuanto mayores son, en lugar de obtener mejores precios. Cuanto más relevante es su rol en la competencia, mayor resulta su erogación.
::::
...
```{=html}
<div style="display: flex; gap: 26px; justify-content: center; align-items: stretch; height: 250px;">
  <div style="display: flex; flex-direction: column; justify-content: flex-end; align-items: center; width: 76px;">
    <span style="font-size: 0.5em; color: #e74c3c; margin-bottom: 6px;">&uarr; 0.54</span>
    <div style="width: 56px; height: 152px; background: #e74c3c; border-radius: 4px 4px 0 0;"></div>
    <span style="font-size: 0.42em; margin-top: 10px; color: #bdc3c7;">Comprador</span>
  </div>
  <div style="display: flex; flex-direction: column; justify-content: flex-end; align-items: center; width: 76px;">
    <span style="font-size: 0.5em; color: #2ecc71; margin-bottom: 6px;">&uarr; 0.31</span>
    <div style="width: 56px; height: 87px; background: #2ecc71; border-radius: 4px 4px 0 0;"></div>
    <span style="font-size: 0.42em; margin-top: 10px; color: #bdc3c7;">Vendedor</span>
  </div>
</div>
<div style="font-size: 0.4em; color: #bdc3c7; text-align: center; margin-top: 14px; line-height: 1.4;">
...
La teoría destaca el salario y la cláusula de rescisión. Esa información es inaccesible salvo en Alemania, y su apertura depende de regulaciones: clubes y jugadores tienen incentivos a reservarla.
:::
...
:::: {style="flex: 1; display: grid; grid-template-columns: repeat(3, 1fr); gap: 22px; align-content: space-evenly; font-size: 0.72em; line-height: 1.45;"}
...
Estadísticas más específicas y por competencia, con métodos que penalicen menos la inclusión de variables: Lasso, Ridge o componentes principales.
:::
...
Para atributos y desempeño, incorporar las observaciones sin precio. Para el poder de negociación, restringirse a las transferencias con precio positivo.
:::

::::

## {background-image="fondo.png" background-size="cover" background-opacity="0.6"}
