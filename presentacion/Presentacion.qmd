...
- **delantero / mediocampista** suben y recién ahí son significativos. (Cuando incorporo Valor del plantel)
...
A notar: las posiciones pierden significancia en el Tobit igual que la pierden en el Modelo 1, cuando el valor de los planteles no está. Y es justamente en el Tobit donde el efecto del plantel vendedor se derrumba de 0.31 a 0.11. Las dos cosas podrían ir juntas: la posición discriminaría precios solo mientras el efecto del vendedor esté vivo.
:::
:::
...
Los clubes tienen **derechos de exclusividad** sobre el uso de la fuerza de trabajo del futbolista. <br>
...
:::: {style="flex: 1; display: grid; grid-template-columns: 68% 32%; gap: 38px; align-items: center; margin-top: 10px;"}

::: {style="font-size: 0.88em; line-height: 1.5;"}

::: {style="background: linear-gradient(to right, rgba(189,195,199,0.30) 54%, transparent 54%); padding: 17px 22px; margin-bottom: 14px;"}
Forma de U invertida · **44** (54%)
:::

::: {style="background: linear-gradient(to right, rgba(189,195,199,0.30) 28%, transparent 28%); padding: 17px 22px; margin-bottom: 14px;"}
Sin relación significativa · **23** (28%)
:::

::: {style="background: linear-gradient(to right, rgba(155,89,182,0.55) 13%, transparent 13%); padding: 17px 22px; margin-bottom: 14px; border-left: 4px solid #9b59b6;"}
Relación decreciente · **11** (13%) — [este trabajo]{style="color: #9b59b6;"}
:::

::: {style="background: linear-gradient(to right, rgba(189,195,199,0.30) 4%, transparent 4%); padding: 17px 22px; margin-bottom: 14px;"}
Forma de U · **3** (4%)
:::

::: {style="font-size: 0.5em; color: #bdc3c7; margin-top: 6px;"}
Distribución de la forma funcional en las 82 especificaciones que incorporan la edad.
:::

:::

::: {style="font-size: 0.66em; line-height: 1.6; color: #bdc3c7; border-left: 3px solid rgba(255,255,255,0.28); padding-left: 22px;"}
**Franceschi (2024)** revisa sistemáticamente **29 artículos** con **111 especificaciones** sobre valoración de futbolistas.

Predominan las ligas europeas —la Premier League es la más estudiada— y solo dos casos salen de Europa.

De esas especificaciones, **82** incorporan la edad.
:::
